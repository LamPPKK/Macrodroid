...
[[ "$TEST_FUNCTION_COUNT" -ge "45" ]] || fail "native test inventory drifted: expected >= 45, found $TEST_FUNCTION_COUNT"
...
print "Macrodroid source validation: OK (unsigned Release build; ${TEST_FUNCTION_COUNT} native tests)"
